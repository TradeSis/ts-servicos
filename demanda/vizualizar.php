...
<body>
    <div class="container-fluid">
        ...
        <div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-fullscreen"> <!-- Modal 1 -->
                <div class="modal-content">
                    <div class="modal-header" style="width: 40vw;">

                        <h5 class="modal-title" id="exampleModalLabel">INFORMAÇÔES PRINCIPAIS</h5>
