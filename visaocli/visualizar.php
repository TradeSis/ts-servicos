                    ...
                    <form id="my-form" action="../database/demanda.php?operacao=alterar&acao=visaocli" method="post">
                        <div class="modal-header p-2 pe-3 border-start">
                            ...
                            <div class="col-md-2 border-start d-flex me-2">
                                <!-- Lucas 10062024 - adicionado condiÁ„o para voltar ao programa de dashboard -->
                    ...
                    <div class="container">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-5 d-flex">
                                ...
                                <span class="ts-subTitulo"><strong>Servi√ßo : </strong> <?php echo $demanda['nomeServico'] ?></span>
                            </div>
                        </div>
                    </div>
